...
const caseStudies: StudyMeta[] = [
  {
    slug: 'aqua-cloud',
    headline: '$1.2M in net-new qualified pipeline in 2.5 months',
    homepageTagLine: 'Growth-stage, GTM, Engineering',
    company: 'aqua cloud',
    role: 'Growth Advisor',
    dateRange: '2024, 8 months',
    cardDescription:
  ...
  },
  {
    ...
    homepageTagLine: 'B2B Marketplace, Scale-up, Sales-led',
    company: 'B2B SaaS',
    role: 'Growth Advisor',
    dateRange: '2024, 8 months',
    cardDescription:
    ...
    logo: '/rrlogo.png',
    website: 'rentready.com',
    companyType: 'B2B Marketplace',
    companyStage: '2014, US',
    funding: 'Series A',
    teamSize: '116',
    engagement: 'Product Growth Lead',
