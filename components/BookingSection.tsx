          ...
          >
            ...
            >
              {track.map((logo, i) => (
                <div
                  key={`${logo.alt}-${i}`}
                  className="mx-[22px] flex items-center"
                >
